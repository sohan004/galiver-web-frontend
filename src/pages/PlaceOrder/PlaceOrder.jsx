                ...
                <div className=" gap-5  flex flex-col md:flex-row px-3">
                    ...
                    <div className="w-full shadow-lg rounded-md md:w-[30%] bg-white p-3">
                        ...
                        <div className=" flex mb-20 flex-col gap-1    ">
                            ...
                            <p className="text-sm flex items-center text-gray-800 justify-between "><span>Delivary Charge
                                <span
                                    onClick={() => setShowModal(true)}
                                    className='bg-orange-500 text-white text-xs rounded-full px-1 ms-1 cursor-pointer'>Change</span>
                            </span> <span className="font-light">৳{deliveryCharge}</span></p>
