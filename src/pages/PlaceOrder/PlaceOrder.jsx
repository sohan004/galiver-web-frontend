...
const PlaceOrder = () => {
    return (
        <div className="max-w-[1188px] mx-auto gap-3  mt-4 flex flex-col md:flex-row px-3">
            <div className="w-full md:w-[70%] ">
                <div className="flex justify-center items-center bg-orange-600 text-white  h-10 rounded-md">
                    + add address
                </div>
                <div className="mt-2 rounded-md shadow p-2 bg-white">
                    {
            ...
            <div className="w-full shadow rounded-md md:w-[30%] bg-white p-3">
                ...
                <div className="mt-7 flex flex-col gap-1   mb-7 ">
                ...
                <div className="fixed left-0 md:static bottom-0 w-full ">
