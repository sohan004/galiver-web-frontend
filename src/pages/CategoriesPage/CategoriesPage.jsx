...
const CategoriesPage = () => {
    ...
    return (
        <div className='max-w-[1188px] mx-auto flex items-start'>
            ...
            <div className='flex-grow h-[100vh] overflow-y-auto z-20'>
                <div className='w-full grid grid-cols-2 gap-[2px]  md:grid-cols-3 lg:grid-cols-4'>
                    <div className='px-1 py-4 lg:p-3 bg-white duration-300 hover:scale-105 hover:shadow-lg hover:bg-slate-200 cursor-pointer'>
