...
const SearchPage = () => {
    ...
    return (
        <div className="w-full mt-5 lg:mt-8 pb-5">
            <NavLink to='/' className="mb-2 flex items-center gap-2 text-sm cursor-pointer text-orange-600"><FaArrowLeft className="text-orange-700" /> Back Home</NavLink>
           {getInputSearchText() && <p className="text-xs md:text-sm lg:text-base mb-2">Search : <span className="text-gray-500">{getInputSearchText()}</span></p>}
