...
import { toggleSignIn } from "../SignIn/SignIn";


// eslint-disable-next-line react-refresh/only-export-components
export const toggleSignUp = (e) => {
    toggleModal('signUp-parent', 'sign-up', e)
}
...
const SignUp = () => {
    ...
    return (
        <>
            <div id="signUp-parent" className="fixed hidden top-0 left-0 w-full h-full overflow-hidden backdrop-blur-sm bg-[#000000a1] z-[9999]"></div>

            <div id='sign-up' className="select-none max-w-[520px] fixed  p-4 top-2/4 invisible scale-90 opacity-0 left-2/4 -translate-x-2/4 duration-300  w-full -translate-y-2/4 z-[99999]">
                ...
                <div className="rounded-lg bg-white relative">
                    ...
                    <div className="px-7 pt-4 pb-8 rounded-3xl shadow-xl">
                        <div className="mx-auto text-center">
                            <h1 className="text-2xl md:text-3xl text-gray-800">Sign Up</h1>
                            <p className="mt-2">How do you want to sign up ?</p>
                        </div>
                        ...
                        <form action="" method="POST">
                            <div className="relative">
                                ...
                                <label htmlFor="name" className="absolute left-0 -top-3.5 text-gray-600 text-sm transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-placeholder-shown:top-2 peer-focus:-top-3.5 peer-focus:text-orange-600 peer-focus:text-sm">Name</label>
                            </div>
                            ...
                            <button type="button" className="w-full mt-5 md:mt-7 py-2 md:py-3 text-lg text-white font-semibold text-center rounded-full bg-orange-600 transition-all hover:bg-orange-700 focus:outline-none">Sign Up</button>
                            <p className="text-center text-sm text-gray-400 mt-4">Already have an account ? <span
                            onClick={openSignIn}
                            className="font-semibold text-orange-600 hover:underline">Sign In</span></p>
                        </form>
                    </div>
                </div>
            </div>
