...
const SignUp = () => {
    ...
    return (
        <>
            ...
            <div id='sign-up' className="select-none max-w-[520px] fixed  p-4 top-[0%] scale-0 opacity-0 left-2/4 -translate-x-2/4 duration-500  w-full -translate-y-2/4 z-[99999]">
